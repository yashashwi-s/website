  ...
  return (
    <main id="arras-page">
      ...
      <header className="ar-wrap ar-hero">
        ...
        <div className="ar-hero-copy"><p>Arras is a free, native Mac photo widget that keeps each image’s original aspect ratio. Your photos, without forced cropping. Their shape, their place, your desktop.</p><a className="ar-button" href={download}>Download Arras <span>↙</span></a><p className="ar-fine">Free & open source · macOS 14+ · Apple silicon</p><p className="ar-fine">Previously Photo Widget OSX and Tableau.</p><a className="ar-text-link" href="#install">First time installing? Read this first →</a></div>
      </header>
      ...
      <section id="controls-and-limits" className="ar-wrap ar-section">
        <div className="ar-split"><div><p className="ar-label">Beyond the first photo</p><h2>More control.<br />Clear limits.</h2><p className="ar-intro">The details that matter when you live with Arras every day.</p><p className="ar-fine">Checked against the <a href={`${SOURCE}/blob/v2.4.6/FEATURES.md`}>v2.4.6 feature documentation ↗</a>. These are documented capabilities, not performance benchmarks.</p></div><div className="ar-install-notes">
